...
import { StreamMedia, VideoTile, OnRenderAvatarCallback, VideoStreamOptions } from '@azure/communication-react'
  ...
  (props: {
    ...
    useEffect(() => {
      if (isAvailable && !renderElement) {
        onCreateLocalStreamView && onCreateLocalStreamView(remoteVideoViewOptions);
      }
      // Always clean up element to make tile up to date and be able to dispose correctly
      // TODO: Add an extra param to onDisposeRemoteStreamView(flavor(optional)) after GA
    ...
    }, [onDisposeLocalStreamView, isScreenSharingOn]);
